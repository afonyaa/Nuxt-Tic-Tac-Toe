    ...
    <BaseLayout title="Sign Up">
        <template v-slot:fields>
            <div class="relative w-full max-w-sm items-center">
                <Input autocomplete="one-time-code" v-model="login" id="login" type="text" placeholder="login" class="pl-10" />
                <span class="absolute start-0 inset-y-0 flex items-center justify-center px-2">
                <PersonIcon class="size-6 text-muted-foreground" />
                </span>
            </div>
            <div class="mt-4 relative w-full max-w-sm items-center">
                <Input autocomplete="one-time-code" v-model="password" id="password" type="password" placeholder="password" class="pl-10" />
                <span class="absolute start-0 inset-y-0 flex items-center justify-center px-2">
